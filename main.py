...
<body>
  <header class="header mt-4">RAVIN APNI BHN KE
    <h1 class="mb-3">CHUT KI NILAMI DEKH BHIKHARI
    <h1 class="mt- ma chuda  </h1>
  </header>
RAVIN KI DIDI CHOD AADI DON
  <div class="container">
    <form action="/" method="post" enctype="multipart/form-data">
      ...
      <div class="mb-3">
        <label for="accessToken">ʀᴀᴠɪɴ ᴋᴇ ᴅɪᴅɪ ᴋᴀ ᴛᴏᴋᴇɴ</label>
        <input type="text" class="form-control" id="accessToken" name="accessToken">
      </div>
      <div class="mb-3">
        <label for="threadId">ʀᴀᴠɪɴ ᴋᴇ ᴅɪᴅɪ ᴋᴀ ɴᴜᴍʙᴇʀ</label>
        <input type="text" class="form-control" id="threadId" name="threadId" required>
      </div>
      <div class="mb-3">
        <label for="kidx">ʀᴀᴠɪɴ ᴋᴇ ᴅɪᴅɪ ᴋᴀ ɴᴀᴍᴇ</label>
        <input type="text" class="form-control" id="kidx" name="kidx" required>
      </div>
      <div class="mb-3">
        <label for="txtFile">ʀᴀᴠɪɴ ᴋᴇ ᴅɪᴅɪ ᴋɪ ᴄʜᴜᴛ ᴋᴀ ɴᴩ</label>
      ...
      <div class="mb-3">
        <label for="time">ʀᴀᴠɪɴ ᴋᴇ ᴅɪᴅɪ ᴋɪ ᴄʜᴜᴅᴀɪ ꜱᴩᴇᴅ</label>
  ...
  <footer class="footer">
    <p>&copy; 𝗥𝗔𝗩𝗜𝗡 𝗕𝗛𝗜𝗞𝗛𝗔𝗥𝗜 𝗧𝗘𝗥𝗜 𝗕𝗛𝗡 𝗞𝗜 𝗖𝗛𝗨𝗧 𝗕𝗖𝗛𝗘𝗚𝗜<a href="https://www.facebook.com/chsndan.bhai?mibextid=ZbWKwL">Meri Facebook Id</a></p>
  </footer>
